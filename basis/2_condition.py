...
'''
if True:
    print('True')  # этот принт сработает
if False:
    print('False')  # этот принт не будет выполнен
...
"""
print("not False:", not False)  # выведется "not False: True"

print("1 is 1:", 1 is 1)  # возвращает True, вроде все просто, НО....
print('1000 is int("1000"):', 1000 is int("1000"))  # возвращает False!
print('1000 == int("1000"):', 1000 == int("1000"))  # когда простое == - True
# если сравнить два одинаковых списка...
print("[1, 2, 3] is [1, 2, 3]:", [1, 2, 3] is [1, 2, 3])  # выведет False
"""
...
для обозначения слубежных символов, так называемых escape sequence, таких как
